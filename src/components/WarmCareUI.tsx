          ...
          <div className="space-y-4 relative" style={{ minHeight: '220px' }}>
            {currentStepData.type === "emoji" ? (
              <div className="flex justify-around">
                {currentStepData.options.map((option: StepOption, index) => (
                  <Button
                    key={index}
            ...
            <div className={`absolute inset-0 top-[-1rem] bottom-[-1rem] flex items-center justify-center bg-orange-50 transition-all duration-300 ease-in-out ${showFeedback ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
